	...
	var crTranslations = {
		"en": {
			"LABELS": {
				...
				"CARDNUMM":"Card number has to be at lest 16 digits long.",
				"SECCODEM":"Security code has to be at lest 3 digits long.",
		...
		"sr-latn": {
			...
			"LABELS": {
				...
				"EXPMONTH":"Mesec kada kartica ističe  ",
				"EXPYEAR":"Godina isticanja kartice",
				...
				"CARDNUMM":"Broj kartice se sastoji od 16 cifara.",
				"LETTERS":"Polje treba da sadrži samo slova.", 
				"SECCODEM":"Sigurnosni kod se sastoji od 3 cifre.",
